...
public class MiniCParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("MiniC");
  ...
  { 
    MiniCParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = MiniCParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MiniCParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MiniCParseControllerGenerated.class);
    }
  ...
  { 
    return MiniCParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
